...
![聽音樂](/blog/fix-music-lag/music.jpg)
...
![Windows網際網路設定](/blog/fix-music-lag/windows-network-settings.jpg)
...
![Discord Status](/blog/fix-music-lag/discord-status.png)
...
![Discord 語音頻道](/blog/fix-music-lag/edit-channel-settings.png)

3. 在下方 `地區覆寫` 嘗試選擇不同的區域

![Discord 語音地區編輯](/blog/fix-music-lag/edit-voice-region.png)
