---
title: "Python DS"
description: Learn Python and its key libraries for data science.
icon: LuAlbum
---
...
Welcome to the **Python Data Science** course! In this course, you will learn Python and its essential libraries for data science, from the basics to advanced topics.

Whether you're a beginner or looking to improve your skills, this course will guide you every step of the way.
